        ...
        <div class="carousel-inner">
          ...
          <div class="carousel-item active">
            ...
            <picture class="carousel-img-one">
              ...
              <source media="(max-width: 650px)" srcset="img/home-carrocel/bombom_abeto_uva_sm.png">

              <source media="(max-width: 1000px)" srcset="img/home-carrocel/bombom_abeto_uva.png">
          ...
          <div class="carousel-item">
            ...
            <picture class="carousel-img-two">
              ...
              <source media="(max-width: 650px)" srcset="img/home-carrocel/bombom_aberto_morango_sm.png">

              <source media="(max-width: 1000px)" srcset="img/home-carrocel/bombom_aberto_morango.png">
            ...
            <div class="card-home" data-anime="left">
              ...
              <div class="box-img" data-text="saiba mais">
                ...
                <picture>
                  ...
                  <img src="img/products-sell/<?= $produto->img; ?>_m.png" alt=<?= $produto->nome; ?>>
                </picture>
       ...
       -->
          ...
          <div class="card-empty-product">
            ...
            <h2>nenhum produto encontrado<h2>
                ...
                <a type="button" class="btn btn-outline-warning" href="controller/carrinhoController.php">Meus Pedidos</a>
          </div>
  ...
  <footer class="fotter">
    ...
    <div class="fotter-info">
      ...
      <div class="footer-developer">
        <a href="https://github.com/RonaldoFagundes" target="_blank">
          <p>dev RFagundes</p>
        </a>
      </div>
