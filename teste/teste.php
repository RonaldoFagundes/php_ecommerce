...
<body>
  ...
  <main>
    ...
    <div class="pedido">     
      <a href="https://wa.me/5521993067274?text=gostaria%20de%20fazer%20um%20pedido" target="_blank">Faça seu Pedido!
 ...
 <div class="to-top">  
   ...
   <path fill-rule="evenodd"
      ...
      <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
          ...
          <div class="carousel-item active"> 
            <picture>
              <source media="(max-width: 650px)" srcset="img/carrocel_banoffee_sm.png">
              <source media="(max-width: 1000px)" srcset="img/carrocel_banoffee_m.png">
              <img src="img/carrocel_banoffee_lg.png"  class="img-fluid" alt="Banoffee">
            </picture>
          </div>

          <div class="carousel-item">  
            <picture>				     	 
              <source media="(max-width: 650px)" srcset="img/carrocel_pudim_sm.png">
              <source media="(max-width: 1000px)" srcset="img/carrocel_pudim_m.png">
              <img src="img/carrocel_pudim_lg.png"  class="img-fluid" alt="Pudim">
           </picture>
          </div>

          <div class="carousel-item">   
            <picture>   					 
              <source media="(max-width: 650px)" srcset="img/carrocel_brigadeirao_sm.png">
              <source media="(max-width: 1000px)" srcset="img/carrocel_brigadeirao_m.png">
              <img src="img/carrocel_brigadeirao_lg.png"  class="img-fluid" alt="Brigadeirão">
            </picture>
          </div>
    ...
    <div class="carrinho">
       <span>Quantidade  <?=$carrinho->getQuantity();?>  itens</span>
       <a href="controller/carrinhoController.php?action=clear">Esvaziar carrinho</a>
    </div>
     ...
     ?>
      ...
      <div class="card-home" data-anime="left">
        ...
        <div class="box-img" data-text="saiba mais">
         ...
         <picture>  					 
           <source media="(max-width: 300px)" srcset="img/<?=$produto->img;?>_sm.png"> 
           
           <img src="img/<?=$produto->img;?>_m.png" alt="pudim">
         </picture> 
